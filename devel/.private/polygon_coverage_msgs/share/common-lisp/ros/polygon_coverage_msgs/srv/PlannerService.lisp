...
(cl:defmethod cl:initialize-instance :after ((m <PlannerService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlannerService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name polygon_coverage_msgs-srv:<PlannerService-request> is deprecated: use polygon_coverage_msgs-srv:PlannerService-request instead.")))

(cl:ensure-generic-function 'start_pose-val :lambda-list '(m))
(cl:defmethod start_pose-val ((m <PlannerService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader polygon_coverage_msgs-srv:start_pose-val is deprecated.  Use polygon_coverage_msgs-srv:start_pose instead.")
  (start_pose m))

(cl:ensure-generic-function 'goal_pose-val :lambda-list '(m))
(cl:defmethod goal_pose-val ((m <PlannerService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader polygon_coverage_msgs-srv:goal_pose-val is deprecated.  Use polygon_coverage_msgs-srv:goal_pose instead.")
  (goal_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlannerService-request>)))
  ...
  "polygon_coverage_msgs/PlannerServiceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlannerService-request)))
  "Returns string type for a service object of type 'PlannerService-request"
  "polygon_coverage_msgs/PlannerServiceRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<PlannerService-request>)))
  ...
  "041d814b74649941198af640c3963ac3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'PlannerService-request)))
  "Returns md5sum for a message object of type 'PlannerService-request"
  "041d814b74649941198af640c3963ac3")
...
(cl:defmethod cl:initialize-instance :after ((m <PlannerService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlannerService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name polygon_coverage_msgs-srv:<PlannerService-response> is deprecated: use polygon_coverage_msgs-srv:PlannerService-response instead.")))
...
(cl:defmethod sampled_plan-val ((m <PlannerService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader polygon_coverage_msgs-srv:sampled_plan-val is deprecated.  Use polygon_coverage_msgs-srv:sampled_plan instead.")
  (sampled_plan m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlannerService-response>)))
  ...
  "polygon_coverage_msgs/PlannerServiceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlannerService-response)))
  "Returns string type for a service object of type 'PlannerService-response"
  "polygon_coverage_msgs/PlannerServiceResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlannerService)))
  ...
  "polygon_coverage_msgs/PlannerService")